...
def predict_primary():
    predictor = IntentPredictor("./models/primary", intent_to_id=primary_intent_to_id)
    predictor.run_repl()
...
def predict_all():
    ...
    while True:
        ...
        messaging_intent, messaging_probabilities = messaging_predictor.predict(
            user_input
        )
...
def train_distilled():
    train_contact_distiller()
    train_messaging_distiller()
